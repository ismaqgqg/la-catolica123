document.addEventListener('DOMContentLoaded', function() {
  ...
  function cambiarDiapositiva(direccion) {
    ...
    diapositivaActual = (diapositivaActual + direccion + totalDiapositivas) % totalDiapositivas;
    document.querySelector('.slides-carrusel').style.transform = `translateX(-${diapositivaActual * 100}%)`;
  }
